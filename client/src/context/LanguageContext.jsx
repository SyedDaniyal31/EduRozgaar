...
const translations = {
  en: {
    nav: { jobs: 'Jobs', scholarships: 'Scholarships', admissions: 'Admissions', blog: 'Blog', contact: 'Contact', dashboard: 'Dashboard', profile: 'Profile', login: 'Login', register: 'Register', resume: 'Resume', education: 'Education', examPrep: 'Exam Preparation', internships: 'Internships & Trainings', webinars: 'Webinars', intlScholarships: 'International Scholarships', foreign: 'Foreign Studies', schoolsAndColleges: 'Schools & Colleges' },
  ...
  ur: {
    nav: { jobs: 'نوکریاں', scholarships: 'اسکالرشپس', admissions: 'داخلے', blog: 'بلاگ', contact: 'رابطہ', dashboard: 'ڈیش بورڈ', profile: 'پروفائل', login: 'لاگ ان', register: 'رجسٹر', resume: 'ریزیومے', education: 'تعلیم', examPrep: 'امتحان کی تیاری', internships: 'انٹرن شپس', webinars: 'ویبینارز', intlScholarships: 'بین الاقوامی اسکالرشپس', foreign: 'غیر ملکی تعلیم', schoolsAndColleges: 'اسکول اور کالج' },
