...
const translations = {
  en: {
    nav: { jobs: 'Jobs', scholarships: 'Scholarships', admissions: 'Admissions', blog: 'Blog', contact: 'Contact', dashboard: 'Dashboard', profile: 'Profile', login: 'Login', register: 'Register', resume: 'Resume', education: 'Education', foreign: 'Foreign Studies', schoolsAndColleges: 'Schools & Colleges' },
  ...
  ur: {
    nav: { jobs: 'نوکریاں', scholarships: 'اسکالرشپس', admissions: 'داخلے', blog: 'بلاگ', contact: 'رابطہ', dashboard: 'ڈیش بورڈ', profile: 'پروفائل', login: 'لاگ ان', register: 'رجسٹر', resume: 'ریزیومے', education: 'تعلیم', foreign: 'غیر ملکی تعلیم', schoolsAndColleges: 'اسکول اور کالج' },
